  ...
  <ScrollView>
    <View>
      <View style={styles.text}>
        <Text
          style={{ marginRight: 80, margin: 10, fontWeight: "bold" }}
          category="label"
        >
          Improve the Probability of receiving the right answer.
        </Text>
        <Button style={{ marginRight: 260 }} appearance="outline">
          Add Crop
        </Button>
      </View>
      <View style={{ paddingVertical: 10, backgroundColor: "white" }}>
        <Text style={{ marginLeft: 15, margin: 5, fontWeight: "bold" }}>
      ...
      <View style={{ margin: 10, backgroundColor: "white" }}>
        ...
        <Textarea
          style={{ marginLeft: 5 }}
          placeholder="Describe specialities such as change of leaves,roots,color,bugs,tears..."
        ></Textarea>
      </View>
    </View>
  </ScrollView>
